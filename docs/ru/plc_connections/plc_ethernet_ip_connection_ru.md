...
| **Роутинг (Routing)** | *Опционально.* Путь CIP (CIP Path) для доступа к процессору, если он находится не в том же слоте, куда приходит Ethernet, или в другом шасси.<br>*Формат:* Обычно указывается как последовательность пар `Порт,Адрес`.<br>*Пример:* `1,0` (Backplane, Slot 0). Оставьте пустым для CompactLogix (без шасси). |
...
## 💡 Чек-лист системного аналитика (Troubleshooting)
